...
import Models exposing (Driver, Material, Model)
...
getMaterialName : Maybe Material -> String
...
tableView driver =
  table [ class "table table-sm table-striped" ] [
    tbody [] [
      row "Basket Frame" (getMaterialName driver.basket_frame),
      ...
      row "Cone" (getMaterialName driver.cone),
      ...
      row "Magnet" (getMaterialName driver.magnet),
